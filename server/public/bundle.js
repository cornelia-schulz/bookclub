...
function getAllBooks() {
  return _superagent2.default.get('/api/v1/books').then(function (res) {
    return res.body;
  }).catch(function (err) {
    console.error(err);
  });
...
var _Books = __webpack_require__(/*! ./Books */ "./client/components/Books.jsx");
...
var Books = function (_React$Component) {
  ...
  _createClass(Books, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _apiClient.getAllBooks)().then(function (books) {
      ...
      return _react2.default.createElement(
        ...
        function (t, _ref) {
          ...
          return _react2.default.createElement(
            ...
            _this3.state.books && _react2.default.createElement(
              'ul',
              null,
              _this3.state.books.map(function (book) {
                return _react2.default.createElement(
                  'li',
                  { key: book.id },
                  book.title
